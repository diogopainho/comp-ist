...
class funccall_node; 
class and_node; 
class adressmemory_node; 
class next_node; 
class reservememory_node; 
class read_node; 
class or_node; 
class not_node; 
