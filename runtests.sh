...
DIR="tests-pwn-daily-201504081911/auto-tests/"
EXPECTED="tests-pwn-daily-201504081911/auto-tests/expected/"
...
echo
echo "Nota: Se precisares podes ver os .output gerados para ver o que aconteceu durante o ./pwn file.pwn"
